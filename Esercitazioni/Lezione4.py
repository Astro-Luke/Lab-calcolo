...
# Esercizio 5
'''
Implementare un generatore di numeri pseudo-casuali che utilizzi il metodo try-and-catch per generare numeri pseudo-casuali 
in base a una distribuzione di probabilità arbitraria.
...
'''
Implementare un generatore di numeri pseudo-casuali che utilizzi il metodo della funzione inversa per generare eventi distribuiti 
secondo una distribuzione di probabilità esponenziale.
Utilizzare la matplotliblibreria per visualizzare la distribuzione dei numeri generati.
'''
...
Verificare visivamente che all'aumentare del numero di eventi aumenta la similarità tra la distribuzione ottenuta 
e la forma funzionale gaussiana, sia graficamente sia utilizzando i momenti delle distribuzioni calcolati sul campione di eventi generato.
'''
