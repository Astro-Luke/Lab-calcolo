...
# L'obiettivo di questo esercizio è creare una libreria Python che implementi una classe Fraction.
# La classe rappresenta una frazione matematica e include:
# 1. Un costruttore per inizializzare il numeratore e il denominatore.
# 2. Metodi per restituire la divisione numeratore/denominatore.
# 3. Sovraccarico degli operatori matematici (+, -, *, /) per operare tra frazioni.
...
# In questo esercizio, viene implementata una funzione di test per verificare il comportamento
# della classe Fraction. Questa funzione:
# - Crea un'istanza della classe.
# - Stampa il numeratore, il denominatore e il valore decimale della frazione.
...
# L'obiettivo di questo esercizio è aggiungere il sovraccarico degli operatori matematici (+, -, *, /)
# alla classe Fraction. Ogni operatore restituisce una nuova istanza della classe Fraction.
# Viene inoltre aggiornata la funzione di test per verificare il corretto comportamento degli operatori.
...
# Questo esercizio utilizza la funzione filter per suddividere i dati in due gruppi:
# - Numeri maggiori della media.
# - Numeri minori della media.
# L'obiettivo è dimostrare che la deviazione standard dei sottoinsiemi è la metà di quella del campione originale.
...
# In questo esercizio si utilizzano la funzione map e lambdas per creare distribuzioni
# dei quadrati e cubi dei numeri casuali letti da un file.
# Le distribuzioni sono rappresentate graficamente in un istogramma condiviso.
